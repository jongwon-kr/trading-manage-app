...
export function Analysis() {
  ...
  const { marketData, preMarketAnalysis, watchlist, isLoading, lastUpdate } =
    ...
    const interval = setInterval(() => {
      marketData.forEach((stock) => {
        ...
        const newChangePercent =
          stock.changePercent + (Math.random() - 0.5) * 0.2;
    ...
    <div className="flex items-center justify-between p-3 hover:bg-muted/50 rounded-lg transition-colors cursor-pointer">
      ...
      <div className="text-right">
        ...
        >
          ...
          <span>
            {formatNumber(stock.change, 2)} ({formatNumber(stock.changePercent)}
            %)
          </span>
        </div>
      </div>
      ...
      >
        <Star
          className={`h-4 w-4 ${
            isInWatchlist(stock.symbol) ? "fill-yellow-400 text-yellow-400" : ""
          }`}
        />
      </Button>
    </div>
  ...
  const watchlistStocks = filteredData.filter((stock) =>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              <Badge
                variant={
                  analysisData.marketOverview.trend === "bullish"
                    ? "default"
                    : "secondary"
                }
                className={
              ...
              >
                {analysisData.marketOverview.trend === "bullish"
                  ? "강세장"
                  : analysisData.marketOverview.trend === "bearish"
                  ? "약세장"
                  : "보합"}
              </Badge>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-2xl font-bold">
                  {analysisData.marketOverview.volatility === "high"
                    ? "높음"
                    : analysisData.marketOverview.volatility === "medium"
                    ? "보통"
                    : "낮음"}
                </span>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-2xl font-bold text-blue-600">
                  {analysisData.marketOverview.volume === "high"
                    ? "높음"
                    : analysisData.marketOverview.volume === "normal"
                    ? "보통"
                    : "낮음"}
                </span>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-1">
                  ...
                  {filteredData.filter((stock) => stock.changePercent > 0)
                    .length === 0 && (
